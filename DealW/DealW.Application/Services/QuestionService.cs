...
namespace DealW.Application.Services
{
    public class QuestionService
    {
        ...
        private static bool CheckTextInputAnswer(Question question, string userAnswer)
        {
        ...
        private static bool CheckMultipleChoiceAnswer(Question question, string userAnswer)
        {
        ...
        private static bool CheckFillBlanksAnswer(Question question, string userAnswer)
        {
            ...
            if (string.Equals(question.CorrectAnswer.Trim(),
                    userAnswer.Trim(),
                    StringComparison.OrdinalIgnoreCase))
                return true;
            ...
            {
                var userValues = userAnswer
                    .Split(';')
                    .Select(v => v.Trim())
                    .ToArray();
                var correctValues = question.CorrectAnswer
                    .Split(';')
                    .Select(v => v.Trim())
                    .ToArray();
                ...
                return !userValues.Where((t, i) => !string
                    .Equals(t, correctValues[i], StringComparison.OrdinalIgnoreCase))
                    .Any();
            }
