...
namespace DealW.Infrastructure.Migrations
{
    ...
    [Migration("20250806132552_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DealW.Domain.Models.Duel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("DealW.Domain.Models.DuelQuestion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("DealW.Domain.Models.Question", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("DealW.Domain.Models.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("DealW.Domain.Models.Duel", b =>
                {
                    b.HasOne("DealW.Domain.Models.User", "FirstUser")
                        .WithMany("DuelsAsFirstUser")
                        .HasForeignKey("FirstUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("DealW.Domain.Models.User", "SecondUser")
                        .WithMany("DuelsAsSecondUser")
                        .HasForeignKey("SecondUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("DealW.Domain.Models.User", "Winner")
                        .WithMany()
            ...
            modelBuilder.Entity("DealW.Domain.Models.DuelQuestion", b =>
                {
                    b.HasOne("DealW.Domain.Models.Duel", "Duel")
                        .WithMany("DuelQuestions")
                        .HasForeignKey("DuelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DealW.Domain.Models.Question", "Question")
                        .WithMany("DuelQuestions")
