...
namespace DealW.API.Controllers
{
    ...
    public class QuestionsController(
        ...
        QuestionCacheService questionCacheService) : ControllerBase
    {
        /// <summary>
        ...
        public async Task<IActionResult> CreateTextInputQuestion([FromBody] TextInputQuestionModel model)
        {
            ...
            try
            {
                var question = await questionService.CreateTextInputQuestionAsync(
                    model.Text,
                    model.CorrectAnswer,
                    model.Category,
                    model.Difficulty,
        ...
        public async Task<IActionResult> CreateMultipleChoiceQuestion([FromBody] MultipleChoiceQuestionModel model)
        {
            ...
            try
            {
                var question = await questionService.CreateMultipleChoiceQuestionAsync(
                    model.Text,
                    model.Options,
        ...
        public async Task<IActionResult> CreateFillBlanksQuestion([FromBody] FillBlanksQuestionModel model)
        {
            ...
            try
            {
                var question = await questionService.CreateFillBlanksQuestionAsync(
                    model.Text,
                    model.Template,
                    model.Blanks,
                    model.CorrectAnswer,
        ...
        private static int CountPlaceholders(string template)
        {
            ...
            while ((index = template.IndexOf("__", index, StringComparison.Ordinal)) != -1)
            {
                count++;
        ...
        public async Task<IActionResult> UpdateQuestion(int id, [FromBody] UpdateQuestionModel model)
        {
            ...
            {
                case QuestionType.MultipleChoice when model.CorrectOptionIndex.HasValue:
                ...
                case QuestionType.FillBlanks when !string.IsNullOrEmpty(model.Template):
            ...
            try
            {
                ...
                await questionCacheService.RefreshQuestionCacheAsync();
        ...
        {
            var categories = await context.Questions
                .Select(q => q.Category)
                .Distinct()
                .ToListAsync();
